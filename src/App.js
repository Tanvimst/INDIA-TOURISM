...
function App() {
  ...
  return (
    ...
    <img src="india-logo.jpg" alt="india map" className="img-responsive" width="45%" height="65%"/> 
          ...
          <a href="/india-tourism-app.zip" download>
  <button> india-tourism-app.zip</button>
</a>
    ...
    <section id="taj-mahal">
        ...
        <p>
          ...
          <section id="golden-gateway">
            ...
            <p>The Gateway of India is a historical monument in Mumbai, built in 1924 to commemorate the visit of King George V and Queen Mary.It was the ceremonial entrance for British viceroys and governors when they arrived in India.The last British troops exited India through this gateway in 1948 after independence.</p>
            <a href="https://www.britannica.com/topic/India-Gate/" target="_blank" rel="noopener noreferrer">
           <img src="gloden.jpg" alt="Golden gate" className="img-responsive" width="50%" height="50%" /> 
